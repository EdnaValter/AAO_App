...
namespace AAO_App.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContactId,Firstname,Lastname,Email,Phone")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContactId,Firstname,Lastname,Email,Phone")] Contact contact)
        {
